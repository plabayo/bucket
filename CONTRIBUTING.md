...
1. [File an issue](https://github.com/plabayo/bucket/issues/new).
...
3. Clone the repo: `git clone https://github.com/plabayo/bucket`
4. Change into the checked out source: `cd news`
5. Fork the repo.
6. Set your fork as a remote: `git remote add fork git@github.com:GITHUB_USERNAME/bucket.git`
